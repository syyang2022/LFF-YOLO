...
class GhostNet(nn.Module):
    def __init__(self, cfgs, num_classes=1000, width=1.0, dropout=0.2):
        ...
        self.rate1 = [1, 5, 9]
        self.rate2 = [1, 5, 9]
        self.rspp0 = Rspp(self.rate1, 32)
        self.rspp1 = Rspp(self.rate1, 64)

        # building first layer
        output_channel = _make_divisible(32 * width, 4)
        ...
        self.stage_begin = nn.Sequential(*stages[:1])
        self.stage0 = nn.Sequential(*stages[1:3])
        self.stage1 = nn.Sequential(*stages[3:5])
        self.stage2 = nn.Sequential(*stages[5:7])
        self.stage3 = nn.Sequential(*stages[7:9])
